...
class StzhMkBirthdayMonth extends HTMLElement {
    constructor() { 
        super();
    ...
    connectedCallback() { 
        if (this.isConnected){
            this.loadTemplateToShadow(this.shadow, 'StzhMkBirthdayMonth.html');
        }
    }
...
customElements.define('stzh-mk-birthday-month', StzhMkBirthdayMonth);
