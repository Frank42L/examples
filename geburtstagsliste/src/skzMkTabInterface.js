...
class StzhMkTabInterface extends HTMLElement {
  constructor() { 
      super();
  ...
  connectedCallback() { 
      if (this.isConnected){
          this.loadTemplateToShadow(this.shadow, 'StzhMkTabInterface.html');
       }
  }
  ...
  getPanels() {
    return this.querySelectorAll("stzh-mk-tabinterface-panel");
  }
...
customElements.define('stzh-mk-tabinterface', StzhMkTabInterface);
