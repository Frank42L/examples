...
class StzhMkBirthdayDay extends HTMLElement {
    constructor() { 
        super();
    ...
    connectedCallback() { 
        if (this.isConnected){
            this.loadTemplateToShadow(this.shadow, 'StzhMkBirthdayDay.html');
        }
    }
...
customElements.define('stzh-mk-birthday-day', StzhMkBirthdayDay);
