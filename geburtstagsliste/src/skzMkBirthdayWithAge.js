...
class StzhMkBirthdayWithAge extends HTMLElement {
    constructor() { 
        super();
    ...
    connectedCallback() { 
        if (this.isConnected){
            this.loadTemplateToShadow(this.shadow, 'StzhMkBirthdayWithAge.html');
        }
    }
...
customElements.define('stzh-mk-birthday-with-age', StzhMkBirthdayWithAge);
