...
class StzhMkTabInterfacePanel extends HTMLElement {
    constructor() { 
        super();
    ...
    connectedCallback() { 
        if (this.isConnected){
            this.loadTemplateToShadow(this.shadow, 'StzhMkTabInterfacePanel.html');
        }
    }
...
customElements.define('stzh-mk-tabinterface-panel', StzhMkTabInterfacePanel);
