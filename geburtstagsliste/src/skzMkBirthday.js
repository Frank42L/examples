...
class StzhMkBirthday extends HTMLElement {
    constructor() { 
        super();
    ...
    connectedCallback() { 
        if (this.isConnected){
            this.loadTemplateToShadow(this.shadow, 'StzhMkBirthday.html');
        }
    }
...
customElements.define('stzh-mk-birthday', StzhMkBirthday);
