...
class MfloWidgetCanvas extends HTMLElement { 
    ...
    createTemplate(shadow) {
        ...
        wrapper.setAttribute('class', 'mfloWidgetTitle');
        wrapper.textContent = this.widgetTitle;
        wrapper.setAttribute('class', 'mfloWidgetCanvas');
        
        var countMarker = document.createElement('div');
        countMarker.setAttribute('class', 'mfloCountMarker');
        countMarker.setAttribute('tabIndex', 0);

        var info = document.createElement('div');
        info.setAttribute('class', 'mfloInfo');
        ...
        inhalt.setAttribute('class', 'mfloWidgetInhalt');
        inhalt.textContent = this.textContent;

        var style = document.createElement('style');
        style.textContent = '@import url("assets/css/style_mflo_simulation.css");';
...
customElements.define('mflo-widget-canvas', MfloWidgetCanvas);
