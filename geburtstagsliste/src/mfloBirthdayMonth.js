...
class MfloBirthdayMonth extends HTMLElement {
    constructor() { 
        super();
    ...
    connectedCallback() { 
        if (this.isConnected){
            this.loadTemplateToShadow(this.shadow, 'MfloBirthdayMonth.html');
        }
    }
...
customElements.define('mflo-birthday-month', MfloBirthdayMonth);
